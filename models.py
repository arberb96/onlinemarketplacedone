...
'''
TODO list:
1. evaluate if it is needed to add a category model
1. evaluate if it is needed to add categories as model
2. evaluate if it is needed to add prices as model

'''
class User(Model):
    """User model - describing the buyer"""
    #NOTE: might be a good idea to have a is_business_owner and
    # log them as a business owner
